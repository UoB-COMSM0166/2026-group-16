...
function drawPlayScreen(){
  ...
  if (!gameOver) {
    ...
    if (powerObj.justReleased && powerObj.value > 10) {
      ...
      const proj = cd.spawnProjectile({fromX, fromY, radius: 12, angleObj, powerObj, powerScale: 8, owner: "player"});
    }
    if (ciyangPowerObj.justReleased && ciyangPowerObj.value > 10) {
      ...
      const proj = cd.spawnProjectile({fromX, fromY, radius: 12, angleObj: ciyangAngleObj, powerObj: ciyangPowerObj, powerScale: 8, owner: "dog"});
