class Navigator {
  ...
  _onCharacter(mx, my) {
    ...
    if (mx > 716 && mx < 716 + 135 && my > 402 && my < 402 + 134) {
      if (isP2Turn) dogCharSelectIndex = (dogCharSelectIndex + 3) % 4;
      else          charSelectIndex    = (charSelectIndex    + 3) % 4;
      return;
    }
    // right arrow (1422, 402, 135, 134)
    if (mx > 1422 && mx < 1422 + 135 && my > 402 && my < 402 + 134) {
      if (isP2Turn) dogCharSelectIndex = (dogCharSelectIndex + 1) % 4;
      else          charSelectIndex    = (charSelectIndex    + 1) % 4;
      return;
    }
    // Confirm (1015, 506, 262, 97)
    if (mx > 1015 && mx < 1015 + 262 && my > 506 && my < 506 + 97) {
      if (isDual && _charTurn === 0) {
        // P1 confirmed — now P2 picks
        _charTurn = 1;
      } else {
