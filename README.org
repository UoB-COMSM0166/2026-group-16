...
* TODO Snags
- [ ] Latex snippets should not export an inline link to the file.
- [ ] Latex snippets in Annex should have idiomatic list numbers.
- [ ] Velocity equation should be exported as image so it renders in Github. There is already a link, in place.
- [ ] Collect references and citations and link properly.
...
|                | I used Claude for learning and debugging LaTex and structuring an API query to Jira. I also forgot to       |
|                | reference as I wrote this document  :( I used Claude to link my bibliography to inline citations post-hoc.  |
|                | It was just too painful equally, I asked Claude to write some regex. Regex is just too grim to learn. Sorry |
|----------------+-------------------------------------------------------------------------------------------------------------|
| Helenm Wong    |                                                                                                             |
|----------------+-------------------------------------------------------------------------------------------------------------|
| Prapulla Tangi |                                                                                                             |
