...
[[file:./docs/assignments/week1-ideas.md][week1-ideas.md]]
...
We narrowed to two candidates:  /Puzzles/ and /Artillery/ on the basis of technical feasibility and SDTs covered and then developed a paper prototype for each.
 ...
 [[file:./docs/assignments/week2-game-ideas.md][week2-game-ideas.md]]
...
[[file:report/docs/figures/fsm_contrast.png]]
...
- Decision records: Architecture decisions are stored in =docs/adr/= as numbered [[https://cognitect.com/blog/2011/11/15/documenting-architecture-decisions][Nygard-template]] markdown files. See: seed ADR ([[file:adr/0000-use-adrs.md][=docs/adr/0000-use-adrs.md=]]) in place.
...
- [[file:./docs/assignments/week3-paper-prototype/idea-A/demo(CAT).mp4][Artillery]]
** DONE E. ADRs
Index under [[file:docs/adr/0000-use-adrs.md][docs/adr/]].
** DONE F. Analysis
*** DONE Inputs
*NASA*
