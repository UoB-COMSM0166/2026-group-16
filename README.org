...
** DONE Workflow
Our way of working was codified in [[file:CONTRIBUTING.md][=docs/CONTRIBUTING.md=]] at the start of the project and briefly summarised, here. We opted to take an empirical approach in selecting processes. Despite the popularity of many software focussed project management methodologies and in particular those related to the Agile Manifesto (Scrum, SAFe and Kanban), empirical evidence of their value remains uncertain.
...
In software engineering architectural decisions are design decisions that address architecturally significant requirements; they are considered to be hard to make (Fowler, M., 2003) and expensive to change (Booch, 2016). Architectual Decision Records (ADRs) is a formal document, used to capture significant architectural decisions made during the design and development of system. ADRs are growing in popularity and are being utilsied by gov.uk, RedHat among others.

Ahmeti et al. (2024) show difficulties of documentation culture,  knowledge transfer and  prioritization of information to be documented is well addressed by ADRs and finding cooperation between developers improved as a consequence of using them. Our decisions are stored in =docs/adr/= as numbered [[https://cognitect.com/blog/2011/11/15/documenting-architecture-decisions][Nygard-template]] markdown files. See: starting ADR ([[file:adr/0000-use-adrs.md][=docs/adr/0000-use-adrs.md=]]) in place.
