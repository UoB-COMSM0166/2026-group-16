...
** DONE Priorities
MoSCoW below, with stories scoped to reflect term times and Easter break. /Must/ items are minimum course or personal pride requirements. /Should/ items landing during the final sprint; /Could/ items are realistic within two more weeks; /Won't/ items are explicitly and unfortunatley deferred.
