...
* DONE 3. Design                                       :target_750w:rubic_15:
** DONE 3.1 Overview
...
#+HEADER: :results file graphics :file report/figures/three_layer.png :imagemagick yes
#+HEADER: :iminoptions -density 600 -background none
#+HEADER: :imoutoptions -quality 100
#+HEADER: :headers '("\\usepackage{tufte}")
#+HEADER: :fit yes :border 2mm
...
#+RESULTS: fig:three-layer
[[file:report/figures/three_layer.png]]
...
#+HEADER: :results file graphics :file report/figures/fsm_contrast.png :imagemagick yes
#+HEADER: :iminoptions -density 300 -background none
#+HEADER: :imoutoptions -quality 100
#+HEADER: :headers '("\\usepackage{tufte}" "\\usetikzlibrary{calc,fit}")
#+HEADER: :fit yes :border 2mm
#+BEGIN_SRC latex
\begin{tikzpicture}[
...
#+RESULTS: fig:fsm-contrast
[[file:report/figures/fsm_contrast.png]]
...
#+NAME: fig:sequence
#+HEADER: :results file graphics :file report/figures/sequence.png :imagemagick yes
#+HEADER: :iminoptions -density 300 -background none
#+HEADER: :imoutoptions -quality 100
#+HEADER: :headers '("\\usepackage{tufte}" "\\usetikzlibrary{calc}")
#+HEADER: :fit yes :border 2mm
...
[[file:report/figures/sequence.png]]
** DONE 3.4 Visual style
*** Visual style
...
- Decision records: Architecture decisions are stored in =docs/adr/= as numbered [[https://cognitect.com/blog/2011/11/15/documenting-architecture-decisions][Nygard-template]] markdown files. See: seed ADR ([[file:adr/0000-use-adrs.md][=adr/0000-use-adrs.md=]]) in place.
