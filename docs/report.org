...
#+LATEX_HEADER: \usepackage{tufte}
* TODO
- [ ] do somethign basic regarding diagrams and graphs without backgrounds. Pick line colours that are agnostic to lightmode/darkmode
-
...
#+HEADER: :results file graphics :file report/figures/funnel.png :imagemagick yes
#+HEADER: :iminoptions -density 300 -background none -alpha remove -alpha off
#+HEADER: :imoutoptions -quality 90
#+HEADER: :headers '("\\usepackage{tufte}")
...
#+RESULTS: fig:idea-funnel
[[file:report/figures/funnel.png]]
...
#+HEADER: :results file graphics :file report/figures/onion.png :imagemagick yes
#+HEADER: :iminoptions -density 600 -background none -alpha remove -alpha off
...
#+NAME: fig:use-case
#+HEADER: :results file graphics :file report/figures/use_case.png :imagemagick yes
...
#+RESULTS: fig:use-case
[[file:report/figures/use_case.png]]
...
** TODO 3.1 Overview
TODO: 3-layer sketch /input/ (continuous keystate) + /simulation/ (angle, power, projectile, collision grid) +  /render/.
** DONE 3.2 Class diagram
...
#+HEADER: :results file graphics :file report/figures/class_diagram.png :imagemagick yes
#+HEADER: :iminoptions -density 300 -background none
#+HEADER: :imoutoptions -quality 100
#+HEADER: :headers '("\\usepackage{tufte}" "\\usetikzlibrary{calc}")
#+HEADER: :fit yes :border 2mm
#+BEGIN_SRC latex
\begin{tikzpicture}
...
#+RESULTS: fig:class-diagram
[[file:report/figures/class_diagram.png]]
...
|                      |               | puzzle game concept, continuous-input FSM  |
|----------------------+---------------+--------------------------------------------|
...
*** DONE Code
First run ~M-x org-babel-tangle~ and then execute  ~uv run analyse.py~
